        ...
        <div id="signup-right-panel" style={{ flex: 1, backgroundColor: '#ffffff', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '40px 40px', overflowY: 'auto', position: 'relative' }}>
          ...
          <div style={{ maxWidth: '360px', margin: '0 auto', width: '100%' }}>
            ...
            <div style={{ margin: '20px 0', display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <span style={{ fontFamily: "'DM Sans', sans-serif", fontSize: '12px', color: '#44474c' }}>Or sign up with</span>
              <div style={{ flex: 1, height: '1px', backgroundColor: 'rgba(15,28,44,0.1)' }} />
            </div>

            <button type="button" style={{ width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px', padding: '12px', borderRadius: '8px', backgroundColor: '#F9F9F9', border: '1.5px solid rgba(15,28,44,0.15)', fontFamily: "'DM Sans', sans-serif", fontSize: '14px', fontWeight: 600, color: '#0f1c2c', cursor: 'pointer' }}
